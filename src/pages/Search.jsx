...
const Search = () => {
    ...
    }, [allProducts, query, activeCategory, priceRange, sortBy]);
        ...
        <div className="pt-24 pb-24 max-w-7xl mx-auto px-4 relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                <div>
                    ...
                    <p className="text-muted text-xs font-bold uppercase tracking-widest mt-2">{filteredProducts.length} RESULTS FOUND</p>
                </div>
            ...
            {filteredProducts.length === 0 && (
                <div className="py-32 text-center border-2 border-dashed border-gray-100 rounded-[3rem]">
                    ...
                    <p className="text-muted uppercase tracking-widest font-bold">No results matching your filters.</p>
                    <button 
                        onClick={() => {
                            setActiveCategory('All');
                            setPriceRange('All');
